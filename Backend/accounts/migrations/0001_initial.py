    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin'), ('PLAYER', 'Player'), ('VIEWER', 'Viewer')], default='VIEWER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_type', models.CharField(choices=[('TICKET', 'Match Ticket'), ('STREAM', 'Stream Access'), ('SUBSCRIPTION', 'Subscription')], max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription_type', models.CharField(choices=[('NONE', 'No Subscription'), ('BASIC', 'Basic'), ('PREMIUM', 'Premium')], default='NONE', max_length=10)),
